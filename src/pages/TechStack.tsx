...
const layers = [
  ...
  },
  {
    ...
    tools: [
      ...
      { name: 'Lucide React', version: 'latest', status: 'active' },
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-400 text-lg max-w-3xl">
          تمام فناوری‌های انتخاب‌شده برای ABRAN SYSTEM.
        </p>
      </div>
      ...
      <div className="space-y-4">
        {layers.map((layer) => (
          <div key={layer.name} className="bg-gradient-to-br from-white/5 to-transparent rounded-2xl border border-white/10 p-5">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
              {layer.tools.map((tool) => (
                <div key={tool.name} className="bg-[#050816] rounded-lg p-3 border border-white/5">
