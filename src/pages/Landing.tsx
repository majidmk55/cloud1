    ...
    <div className="min-h-screen bg-[#0a1628] text-white overflow-x-hidden" dir="rtl">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0a1628]/80 backdrop-blur-md border-b border-[#00d4ff]/10">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <a href="#home" className="hover:text-[#00d4ff] transition-colors">خانه</a>
            <a href="#services" className="hover:text-[#00d4ff] transition-colors">خدمات</a>
            <a href="#about" className="hover:text-[#00d4ff] transition-colors">درباره ما</a>
            <a href="#contact" className="hover:text-[#00d4ff] transition-colors">تماس با ما</a>
          </div>

          <button className="px-6 py-2 bg-[#00d4ff] text-[#0a1628] rounded-lg font-bold hover:bg-[#4fc3f7] transition-colors shadow-lg shadow-[#00d4ff]/20">
            شروع کنید
          </button>
        </div>
      </nav>
      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center pt-20">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          ...
          >
            <h1 className="text-6xl md:text-8xl font-black mb-6 bg-gradient-to-l from-white via-[#4fc3f7] to-[#00d4ff] bg-clip-text text-transparent">
              ابران سیستم
            </h1>
            
            <h2 className="text-2xl md:text-3xl text-[#00d4ff] mb-6 font-light">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button className="px-8 py-4 border-2 border-[#00d4ff] text-[#00d4ff] rounded-lg font-bold text-lg hover:bg-[#00d4ff]/10 transition-all">
                اطلاعات بیشتر
              </button>
            </div>
          </motion.div>
            ...
            {services.map((service, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="group relative bg-[#0d2137] rounded-xl p-8 border border-[#00d4ff]/20 hover:border-[#00d4ff]/60 transition-all duration-300 hover:shadow-lg hover:shadow-[#00d4ff]/20"
                >
      ...
      {/* Stats Section */}
      <section ref={statsRef} className="py-24 px-6 bg-gradient-to-b from-[#0d2137] to-[#0a1628]">
        <div className="max-w-7xl mx-auto">
      ...
      <section id="contact" className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-4">تماس با ما</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="bg-[#0d2137] rounded-xl p-8 border border-[#00d4ff]/20"
            >
            ...
            <motion.div
              ...
              className="space-y-8"
            >
              <div className="bg-[#0d2137] rounded-xl p-8 border border-[#00d4ff]/20">
                <h3 className="text-2xl font-bold mb-6 text-[#00d4ff]">اطلاعات تماس</h3>
              ...
              <div className="bg-gradient-to-br from-[#00d4ff]/10 to-[#4fc3f7]/10 rounded-xl p-8 border border-[#00d4ff]/30">
      ...
      {/* Footer */}
      <footer className="bg-[#0d2137] border-t border-[#00d4ff]/10 py-12 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="#" className="hover:text-[#00d4ff] transition-colors">تحلیل داده</a></li>
