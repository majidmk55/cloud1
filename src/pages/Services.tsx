...
const serviceDetails = [
  {
    icon: <Cloud className="w-8 h-8 text-blue-400" />, title: 'سرور ابری', price: '۴۹۰٬۰۰۰',
  ...
  {
    icon: <Server className="w-8 h-8 text-emerald-400" />, title: 'سرور اختصاصی', price: '۲٬۹۰۰٬۰۰۰',
  ...
  {
    icon: <HardDrive className="w-8 h-8 text-purple-400" />, title: 'کولوکیشن', price: '۱٬۵۰۰٬۰۰۰',
  ...
  {
    icon: <Globe className="w-8 h-8 text-cyan-400" />, title: 'CDN و امنیت', price: '۲۹۰٬۰۰۰',
  ...
  {
    icon: <Cpu className="w-8 h-8 text-amber-400" />, title: 'ذخیره‌سازی شیء', price: '۹۰٬۰۰۰',
  ...
  {
    icon: <Shield className="w-8 h-8 text-rose-400" />, title: 'پشتیبان‌گیری و DR', price: '۱۹۰٬۰۰۰',
    ...
    <div className="max-w-7xl mx-auto px-4 md:px-8 py-16">
      ...
      <div className="space-y-8 mb-16">
        {serviceDetails.map((service, i) => (
          <div key={i} className="bg-[#0a0f1f] rounded-2xl border border-white/10 p-6 md:p-8">
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="flex-1">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-3">
                  ...
                  <span className="text-blue-400 font-bold">از {service.price} تومان/ماه</span>
                </div>
      ...
      {/* Comparison Table */}
      <div className="mb-16">
        <h2 className="text-2xl font-bold text-white mb-6 text-center">مقایسه سرویس‌ها</h2>
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-white/10">
                <th className="text-right py-3 px-4 text-gray-400 font-medium">ویژگی</th>
                <th className="text-center py-3 px-4 text-blue-400 font-medium">سرور ابری</th>
                <th className="text-center py-3 px-4 text-emerald-400 font-medium">سرور اختصاصی</th>
                <th className="text-center py-3 px-4 text-purple-400 font-medium">کولوکیشن</th>
              </tr>
            </thead>
